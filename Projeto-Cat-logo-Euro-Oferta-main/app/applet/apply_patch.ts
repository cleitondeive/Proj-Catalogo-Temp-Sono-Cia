  ...
  const rightInsert = `
            ...
            <section className="space-y-4 mb-4">
              ...
              <div className="space-y-3">
                {(!(lead as any).schedules || (lead as any).schedules.length === 0) && !showScheduleForm && (
                ...
                {((lead as any).schedules || []).slice().sort((a: any, b: any) => new Date(a.date).getTime() - new Date(b.date).getTime()).map((sch: any) => {
