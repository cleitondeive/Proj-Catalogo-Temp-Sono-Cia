...
export default function SettingsPage() {
  ...
  const [storeSettings, setStoreSettings] = useState({
    name: localStorage.getItem('euro_store_name') || 'Euro Oferta',
    phone: localStorage.getItem('euro_store_phone') || '5565981183473',
    email: localStorage.getItem('euro_store_email') || 'contato@eurooferta.com',
    instagram: localStorage.getItem('euro_store_instagram') || '@eurooferta',
    facebook: localStorage.getItem('euro_store_facebook') || 'EuroOfertaBR',
    address: localStorage.getItem('euro_store_address') || 'Av. Principal, 1000 - Centro',
  });

  const [success, setSuccess] = useState(false);

  const handleSave = () => {
    localStorage.setItem('euro_store_name', storeSettings.name);
    localStorage.setItem('euro_store_phone', storeSettings.phone);
    localStorage.setItem('euro_store_email', storeSettings.email);
    localStorage.setItem('euro_store_instagram', storeSettings.instagram);
    localStorage.setItem('euro_store_facebook', storeSettings.facebook);
    localStorage.setItem('euro_store_address', storeSettings.address);
